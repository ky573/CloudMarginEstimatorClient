...
class TestLiveSnapshotRequestHandler:
    ...
    def test_initialization(self):
        ...
        with patch('margin_estimator_tool.src.margin_estimator_tool.live_snapshots.live_snapshots_request_handler.RequestHandler._setup_api') as mock_setup_api:
    ...
    def test_process_and_provide_output(self):
        ...
        with patch('margin_estimator_tool.src.margin_estimator_tool.live_snapshots.live_snapshots_request_handler.RequestHandler._setup_api') as mock_setup_api:
            with patch('margin_estimator_tool.src.margin_estimator_tool.live_snapshots.live_snapshots_request_handler.click') as mock_click:
                mock_api = MagicMock()
    ...
    def test_send_request_successful(self):
        ...
        with patch('margin_estimator_tool.src.margin_estimator_tool.live_snapshots.live_snapshots_request_handler.RequestHandler._setup_api') as mock_setup_api:
            with patch('margin_estimator_tool.src.margin_estimator_tool.live_snapshots.live_snapshots_request_handler.RequestHandler._check_for_error_in_response') as mock_check_error:
                mock_api = MagicMock()
                mock_setup_api.return_value = mock_api
    ...
    def test_send_request_exception(self):
        ...
        with patch('margin_estimator_tool.src.margin_estimator_tool.live_snapshots.live_snapshots_request_handler.RequestHandler._setup_api') as mock_setup_api:
            with patch('margin_estimator_tool.src.margin_estimator_tool.live_snapshots.live_snapshots_request_handler.RequestHandler._handle_request_error') as mock_handle_error:
                mock_api = MagicMock()
                mock_setup_api.return_value = mock_api
    ...
    def test_print_output(self):
        ...
        with patch('margin_estimator_tool.src.margin_estimator_tool.live_snapshots.live_snapshots_request_handler.click') as mock_click:
            with patch('margin_estimator_tool.src.margin_estimator_tool.live_snapshots.live_snapshots_request_handler.datetime') as mock_datetime:
                date = "20250301"
                handler = LiveSnapshotRequestHandler(date=date)
