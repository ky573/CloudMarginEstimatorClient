...
class TestMarginCalculatorRequestHandler:
    ...
    def test_process_and_provide_output_valid_headers(self):
        ...
        with patch.object(
            ...
            self.handler, "_fetch_margin_data", return_value=mock_margin_data
        ), patch.object(
            self.handler, "_export_results"
    ...
    def test_collect_business_days(self):
        ...
        with patch.object(
            self.handler, "_is_business_day", side_effect=[True, False, True]
        ):
            ...
            assert business_days == [
                20250303,
                20250305,
            ]  # Should skip the second date (non-business)
    ...
    def test_export_results(self):
        ...
        ) as mock_data_export, patch(
            "margin_estimator_tool.src.margin_estimator_tool.estimator.margin_calculator.graph_exporter.GraphExporter.save_graph"
        ) as mock_save_graph:
    ...
    def test_fetch_margin_data(self):
        ...
        with patch.object(
            ...
            assert margin_data == [
                mock_data
            ]  # Only the valid non-empty response should be included
