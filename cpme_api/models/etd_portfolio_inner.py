...
class EtdPortfolioInner(BaseContent):
    """
    """
    _swagger_types = {
    ...
    _required = ['line_no', 'net_ls_balance']
    ...
    def __init__(self, **kwargs):
        ...
        super(EtdPortfolioInner, self).__init__(**kwargs)
    ...
    @net_ea.setter
    def net_ea(self, value):
        self._assign("net_ea", value)
