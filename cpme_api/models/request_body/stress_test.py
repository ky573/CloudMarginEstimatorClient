...
class BodyStressTest(BaseContent):
    """
    """
    _swagger_types = {
        'clearing_currency': 'ClearingCurrency',
        'is_cross_margined': 'boolean',
        'portfolio_components': 'list[BodyStressTestPortfolioComponents]',
    }
    ...
    def __init__(self, **kwargs):
        ...
        super(BodyStressTest, self).__init__(**kwargs)
...
class BodyStressTestPortfolioComponents(BaseContent):
    """
    """
    _swagger_types = {
        'cash_csv': 'CashCsv',
    ...
    def __init__(self, **kwargs):
        ...
        self._type = None
        super(BodyStressTestPortfolioComponents, self).__init__(**kwargs)
