...
from cpme_api.api.models.responses import products, series
...
class CpmeApi(BaseApi):
    ...
    def indicative_margin_get(self, **kwargs):
        ...
        return self._api_client.call_api(
            ...
            params,
            response_type='IndicativeMargin200Inner'
        )
    ...
    def estimator_post(self, body, **kwargs):
        ...
        :param EstimatorBody body: (required)
        :param str x_dbp_apikey: your key, obtain it by registering at [DBG Digital Business Platform](https://console.developer.deutsche-boerse.com/) (required)
        :return: ResponseEstimator
        """
    ...
    def convert_etd_cp005_post(self, body, **kwargs):
        ...
        This method makes a synchronous HTTP request by default.
        :param str x_dbp_apikey: your key, obtain it by registering at [DBG Digital Business Platform](https://console.developer.deutsche-boerse.com/) (required)
        :param EtdCp005Body body:
        :return: ResponseConvertEtdCp005
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def default_fund_post(self, body, **kwargs):
        ...
        This method makes a synchronous HTTP request by default.
        :param DefaultFundBody body: (required)
        :param str x_dbp_apikey: your key, obtain it by registering at [DBG Digital Business Platform](https://console.developer.deutsche-boerse.com/) (required)
        :return: ResponseDefaultFund
        """
    ...
    def greeks_post(self, body, **kwargs):
        ...
        Calculate analytical greeks (sensitivities) for given exchange traded instruments. The instruments are specified by a technical `iid` that can be obtained by `series` query. Two types of greeks are offered: - numerical derivative of change in instrument price in product currency w.r.t. change in given variable, e.g. DELTA is w.r.t. change in underlying price - the above greek converted to EUR:   - EURO_DELTA, EURO_GAMMA: (_underlying price_ + _price offset_) \\* _greek_ \\* _fx conversion to EUR_   - EURO_RHO, EURO_THETA, EURO_VEGA: _greek_ \\* _fx conversion to EUR_  Optionally, vector of relative underlying shifts can be supplied to calculate stress greeks (except DV01, there shifts are ignored) in scenarios where underlying price moved. Note that the method of calculation is slightly different, therefore the result for request without shift may differ from result with zero shift. To get a position greek, the instrument greek has to be multiplied by position size and trade unit value (TUV).  # noqa: E501
        This method makes a synchronous HTTP request by default.
        :param str x_dbp_apikey: your key, obtain it by registering at [DBG Digital Business Platform](https://console.developer.deutsche-boerse.com/) (required)
        :param GreeksBody body:
        :return: ResponseGreeks
        """
    ...
    def otc_sensitivities_post(self, body, **kwargs):
        ...
        This method makes a synchronous HTTP request by default.
        :param str x_dbp_apikey: your key, obtain it by registering at [DBG Digital Business Platform](https://console.developer.deutsche-boerse.com/) (required)
        :param OtcSensitivitiesBody body:
        :return: ResponseOtcSensitivities
        """
    ...
    def otc_trade_details_post(self, body, **kwargs):
        ...
        This method makes a synchronous HTTP request by default.
        :param str x_dbp_apikey: your key, obtain it by registering at [DBG Digital Business Platform](https://console.developer.deutsche-boerse.com/) (required)
        :param OtcTradeDetailsBody body:
        :return: ResponseOtcTradeDetails
        """
    ...
    def stress_test_post(self, body, **kwargs):
        ...
        This method makes a synchronous HTTP request by default.
        :param StressTestBody body: (required)
        :param str x_dbp_apikey: your key, obtain it by registering at [DBG Digital Business Platform](https://console.developer.deutsche-boerse.com/) (required)
        :return: ResponseStressTest
        """
    ...
    def stressmatrix_post(self, body, **kwargs):
        ...
        This method makes a synchronous HTTP request by default.
        :param str x_dbp_apikey: your key, obtain it by registering at [DBG Digital Business Platform](https://console.developer.deutsche-boerse.com/) (required)
        :param StressmatrixBody body:
        :return: ResponseStressmatrix
        """
