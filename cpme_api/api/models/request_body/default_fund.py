...
class BodyDefaultFund(BaseContent):

    _swagger_types = {
        'clearing_currency': 'ClearingCurrency',
        'include_drilldowns': 'boolean',
        'is_cross_margined': 'boolean',
        'portfolio_components': 'list[BodyDefaultFundPortfolioComponents]',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self._include_drilldowns = None
        self._is_cross_margined = None
        self._portfolio_components = None
        super(BodyDefaultFund, self).__init__(**kwargs)
    ...
    @property
    def include_drilldowns(self):
        return self._include_drilldowns

    @include_drilldowns.setter
    def include_drilldowns(self, value):
        self._assign("include_drilldowns", value)
...
class BodyDefaultFundPortfolioComponents(BaseContent):
    ...
    def __init__(self, **kwargs):
        ...
        self._type = None
        super(BodyDefaultFundPortfolioComponents, self).__init__(**kwargs)
